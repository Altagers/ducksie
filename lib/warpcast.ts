...
export async function getFarcasterManifest() {
  ...
  return {
    ...
    frame: {
      ...
      // Обновляем метаданные, чтобы включить информацию об игре
      subtitle: "Starter kit with Duckie game", 
      description: "Starter kit for mini-apps with Life of Duckie game", 
      primaryCategory: "social",
      tags: ["mini-app", "starter", "game"], 
    ...
    additionalPages: [
      {
        name: "Life of Duckie",
        url: `${appUrl}/game-static/index.html`,
        description: "Play the virtual pet game"
      }
    ]
  };
}
